  ...
  return (
    <div className="group bg-slate-800/50 backdrop-blur-sm rounded-xl border border-slate-700/50 hover:border-purple-500/50 transition-all duration-300 overflow-hidden">
      <div className="relative">
        {/* Rank Badge */}
        <div
          className={`absolute top-3 left-3 z-10 w-8 h-8 rounded-full ${getRankColor(
            rank
    ...
    try {
      ...
      if (categoryFilter !== "all" && categoryFilter !== "pair") {
        profileQuery = profileQuery.eq(
          "type",
          categoryFilter === "pfp" ? "profile" : categoryFilter
        );
      }
      ...
      if (pairsResult?.data) {
        const pairItems: TrendingItem[] = pairsResult.data.map(
          (item, index) => ({
            id: item.id,
          ...
          <div className="space-y-6">
                        ...
                        <div
                          ...
                          style={{
                            width: `${
                              (tag.count /
                                Math.max(
                                  ...stats.trendingTags.map((t) => t.count)
                                )) *
                              100
                            }%`,
                          }}
            ...
            <div className="bg-gradient-to-br from-orange-600/20 to-red-600/20 border border-orange-500/30 rounded-xl p-6">
              ...
              <p className="text-gray-300 text-sm mb-4">
                Get your content featured by creating high-quality profiles that
                the community loves!
              </p>
