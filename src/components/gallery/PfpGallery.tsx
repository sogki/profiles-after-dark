...
import { Download, Heart, Eye, Search, Clock, Tag, Grid3X3, List, Palette, User } from "lucide-react"
  ...
  useEffect(() => {
    async function fetchProfiles() {
      ...
      try {
        ...
        // Fetch user profiles for all profiles
        ...
        if (userIds.length > 0) {
          ...
          profilesData.forEach(profile => {
            profile.user_profiles = userMap.get(profile.user_id);
          });
        }
                      ...
                      <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/40 to-transparent opacity-0 group-hover:opacity-100 transition-opacity flex items-end p-3">
                        <div className="w-full">
                          ...
                          <div className="flex items-center gap-2 text-white text-xs">
                            ...
                            <span>{profile.download_count}</span>
                          </div>
                        </div>
                      </div>
                    </div>
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center gap-4 text-sm text-slate-400 mb-2">
                        <div className="flex items-center gap-1">
                          ...
                          <span>{profile.download_count} downloads</span>
                        </div>
                        {user && (
                          <button
                            onClick={(e) => {
