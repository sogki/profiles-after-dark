...
const appealReasons = [
  {
    ...
    description:
      "Appeal if your content was removed and you believe it does not violate guidelines.",
    icon: FileText,
  },
  {
    title: "Account Suspension",
    description:
      "Appeal if your account was suspended and you believe it was a mistake.",
    icon: Flag,
  },
  {
...
export default function AppealsFormSystem() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (
      banType === "discord" &&
      (!formData.discordTag.trim() || !formData.email.trim())
    ) {
        ...
        <div className="max-w-5xl mx-auto">
          ...
          {submitted && (
            ...
            >
              ...
              <p className="text-lg">
                Your appeal for <strong>{selectedReason}</strong> has been
                submitted successfully. We will review and get back to you via
