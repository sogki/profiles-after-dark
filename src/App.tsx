...
function App() {
  ...
  return (
    <ThemeProvider defaultTheme="dark" storageKey="vite-ui-theme">
      <BrowserRouter>
        <div className="min-h-screen bg-gradient-to-br from-bg-background via-bg-background to-bg-background/40 flex flex-col relative">
          ...
          {announcement && (
            <div className="flex justify-center bg-destructive/50 text-white px-4 py-2 text-center font-semibold">
