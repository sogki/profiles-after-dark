...
interface EmoteUploadFormProps {
  form: {
    title: string
    category: string
...
export default function EmoteUploadForm({
  form,
  onFormChange,
  onFileSelect,
  onSubmit,
  isSubmitting
}: EmoteUploadFormProps) {
    ...
    <form onSubmit={onSubmit} className="space-y-6">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="space-y-4">
          {/* Title */}
          <div>
            <label htmlFor="emoteTitle" className="block text-sm font-medium text-white mb-2">
              Title
            </label>
            <input
              id="emoteTitle"
          ...
          {/* Category */}
          <div>
            <label htmlFor="emoteCategory" className="block text-sm font-medium text-white mb-2">
              Category
            </label>
            <select
              id="emoteCategory"
          ...
          {form.category === "custom" && (
            <div>
              <label htmlFor="emoteCustomCategory" className="block text-sm font-medium text-white mb-2">
                Custom Category
              </label>
              <input
                id="emoteCustomCategory"
                type="text"
