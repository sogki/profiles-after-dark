      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 flex-grow">
        <div className="mb-8">
          ...
          <div className="max-w-md">
            {/* Search Bar */}
            <SearchNew
              inputClassName="w-full px-4 py-2 rounded-md "
        ...
        {filteredUsers.length === 0 ? (
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
            {filteredUsers.map((user) => (
              <Card
                className="relative group rounded-2xl overflow-hidden shadow-xl hover:shadow-2xl transition-all duration-300 hover:scale-105 block pt-0 mt-0"
